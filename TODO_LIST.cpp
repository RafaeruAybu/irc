...
todo: - (JOIN) - разобраться с сегой в Adium при рассылке о коннекте нового юзера
todo: Удаление юзера из Channel при выходе с сервера
todo: Ответ на JOIN ":IRCat 353 oper = #chan :@dduck oper" - список юзеров
^^^Минимальный набор^^^
todo: (LIST)
todo: (PART)
todo: - (OPER)
